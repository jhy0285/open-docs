...
export const th: Dict = {
  ...
  'chat.amrCard.switchBody': 'สลับไปยังบริการโมเดล AMR อย่างเป็นทางการของ Open Docs — ไม่ต้องตั้งค่า API Key หลังจากเข้าสู่ระบบ ให้สิทธิ์ และเติมเงินแล้ว งานนี้จะถูกลองใหม่โดยอัตโนมัติ',
  ...
  'chat.runError.signInMessage.amr': 'เอเจนต์ Open Docs ยังไม่ได้ลงชื่อเข้าใช้ — ลงชื่อเข้าใช้เพื่อเริ่มใช้งาน',
  'chat.runError.signInMessage.other': '{agent} ยังไม่ได้ลงชื่อเข้าใช้ โปรดตรวจสอบสถานะการลงชื่อเข้าใช้ในเครื่อง เราแนะนำเอเจนต์ Open Docs ที่เสถียรและคุ้มค่ากว่า',
  ...
  'settings.welcomeTitle': 'ยินดีต้อนรับสู่ Open Docs',
  'settings.welcomeSubtitle': '',
  'settings.onboardingCreateTitle': 'เริ่มจากบรีฟ',
  'settings.onboardingCreateBody': 'อธิบายเว็บไซต์ แอป สไลด์ รูปภาพ หรือวิดีโอที่คุณต้องการ Open Docs จะสร้างโปรเจกต์ให้และเก็บงานไว้ให้แก้ไขได้ตลอด',
  ...
  'settings.onboardingMemoryCalloutBody': 'คำตอบเหล่านี้เป็นพื้นฐานของโปรไฟล์หน่วยความจำของคุณ Open Docs จะนำกลับมาใช้ในทุกงาน และเรียนรู้ต่อเนื่องขณะที่คุณทำงาน',
  ...
  'settings.onboardingCloudTitle': 'ลงชื่อเข้าใช้ Open Docs',
  'settings.onboardingCloudBody': 'ลงชื่อเข้าใช้แล้วเริ่มออกแบบด้วย AI บนคลาวด์ได้ทันที โดยไม่ต้องตั้งค่าที่ซับซ้อน',
  'settings.onboardingCloudSignIn': 'ลงชื่อเข้าใช้ Open Docs Cloud',
  ...
  'settings.onboardingGateTooltipAmr': 'ขั้นตอนต่อไปทำงานด้วย AI — ลงชื่อเข้าใช้ Open Docs AMR เพื่อดำเนินการต่อ',
  ...
  'settings.agentInstall.pathHint': 'หากคุณติดตั้ง CLI ด้วย npm หรือ Homebrew แล้วแต่ยังแสดงว่าไม่ได้ติดตั้ง โปรดตรวจสอบว่าโฟลเดอร์ bin ของเครื่องมือนั้นอยู่ใน PATH ที่ Open Docs daemon ใช้งาน (บน macOS ค่า PATH ของ Terminal และแอป GUI อาจต่างกัน) ดู QUICKSTART.md (ส่วน "Local agent CLI and PATH")',
  'settings.agentInstall.stepOpenLinks': 'เปิดลิงก์ติดตั้งหรือเอกสารสำหรับเอเจนต์ที่ต้องการ',
  'settings.agentInstall.stepAuth': 'ยืนยันตัวตนกับ CLI ของผู้ให้บริการ (ลงชื่อเข้าใช้หรือเพิ่มข้อมูลรับรอง API) ก่อนกลับไปที่ Open Docs',
  ...
  'settings.themeCyberpunk': 'ไซเบอร์พังก์',
  ...
  'settings.mcpServerHint': 'เปิดให้ Open Docs เป็นเซิร์ฟเวอร์ MCP สำหรับเอเจนต์โค้ด',
  ...
  'settings.mcpHint': 'ให้ coding agent (Cursor, Claude Code, VS Code…) อ่านโปรเจกต์ Open Docs ของคุณได้โดยตรง',
  'settings.mcpDaemonError': 'ไม่สามารถเชื่อมต่อกับ daemon ในเครื่องเพื่อระบุพาธการติดตั้งได้ ({error}) โปรดตรวจสอบว่า Open Docs กำลังทำงานอยู่ จากนั้นเปิดแผงนี้ใหม่',
  ...
  'settings.mcpCapabilityDefault': 'ตั้งค่าเริ่มต้นเป็นโปรเจกต์และไฟล์ที่คุณเปิดอยู่ใน Open Docs เพื่อให้คุณพูดได้ว่า "สร้างสิ่งนี้ในแอปของฉัน" โดยไม่ต้องระบุดีไซน์ซ้ำอีก',
  'settings.mcpRunningNote': 'Open Docs ต้องกำลังทำงานอยู่เพื่อให้การเรียกเครื่องมือ MCP สำเร็จ หากคุณเริ่มต้นโค้ดดิ้ง Agent ก่อนเปิด Open Docs ให้รีสตาร์ท Agent เพื่อให้สามารถเชื่อมต่อกับ daemon ที่ทำงานอยู่ได้',
  ...
  'homeHero.subtitlePrefix': 'ส่งมอบโดย YoungJin Cho ที่ LGCNS',
  ...
  'homeHero.chip.createPluginHint': 'สร้างปลั๊กอิน Open Docs ที่นำกลับมาใช้ใหม่ได้ และเพิ่มลงในปลั๊กอินของฉัน',
  'homeHero.chip.figmaHint': 'ย้าย frame ของ Figma เข้าสู่ document style ที่ใช้งานอยู่',
  ...
  'handoff.promptIntro': 'ดำเนินการต่อจากโฟลเดอร์โปรเจกต์ Open Docs ในเครื่องนี้:',
  ...
  'designSystemPicker.loading': 'กำลังโหลด document styles…',
  ...
  'designSystemPicker.noPreview': 'ไม่มีหน้าพรีวิว เปิด Document Styles เพื่อดูพรีวิวแบบเต็ม',
  ...
  'pluginsHome.subtitle': 'เวิร์กโฟลว์ Open Docs พร้อมใช้งานที่มาพร้อมกับรันไทม์นี้ เลือกหนึ่งรายการเพื่อโหลดพรอมป์ต์เริ่มต้น หรือเรียกดูรีจิสตรีเพื่อดูเพิ่มเติม',
  ...
  'pluginsHome.emptyCatalog': 'แคตตาล็อกว่างเปล่า ปลั๊กอินที่มาพร้อมกับ Open Docs ควรปรากฏที่นี่โดยอัตโนมัติ — ลองรีสตาร์ท daemon หากยังเกิดปัญหานี้อยู่',
  ...
  'pluginCard.contributeAria': 'ร่วมสนับสนุน {title} ให้กับ Open Docs',
  'pluginCard.contributeTitle': 'ร่วมสนับสนุน plugin ให้กับ Open Docs ด้วย pull request',
  ...
  'integrations.lede': 'เชื่อมต่อระบบภายนอก นำเครื่องมือ MCP เข้าสู่ลูปของ Agent และใช้งาน Open Docs จาก IDE สคริปต์ และระบบอัตโนมัติอื่น ๆ',
  ...
  'mcpClient.daemonError': 'ไม่สามารถเชื่อมต่อกับ daemon ภายในเครื่องได้ โปรดตรวจสอบว่า Open Docs กำลังทำงานอยู่ จากนั้นเปิดแผงนี้อีกครั้ง',
  'mcpClient.saveFailed': 'บันทึกไม่สำเร็จ โปรดตรวจสอบว่า daemon กำลังทำงานอยู่ แล้วลองอีกครั้ง',
  'useEverywhere.modalAria': 'ใช้ Open Docs ได้ทุกที่',
  'useEverywhere.modalTitle': 'ใช้ Open Docs ได้ทุกที่',
  'useEverywhere.modalSubtitle': 'นำ Open Docs ไปใช้ใน IDE, Agent หรือสคริปต์ใดก็ได้ — CLI, HTTP, MCP และ Skills ใช้ “Copy guide for an agent” แล้ววางลงใน Claude Code, Codex, Cursor, openclaw หรือ hermes เพื่อตั้งค่าทุกอย่าง',
  ...
  'useEverywhere.section.overview.bullet4': 'Skills — แพ็ก `SKILL.md` แบบ drop-in (รองรับ Claude) ที่ Agent ใดก็ตามซึ่งอยู่ใน PATH ของคุณสามารถเรียกใช้ได้โดยไม่ต้องมี Open Docs เลย',
  ...
  'useEverywhere.section.cli.heading': 'ควบคุม Open Docs จาก shell ใดก็ได้',
  ...
  'useEverywhere.section.cli.snippet3': 'แสดงรายการสกิลและ document style ที่มีในเครื่อง',
  ...
  'useEverywhere.section.mcp.heading': 'เปิดเผย Open Docs เป็นเซิร์ฟเวอร์ MCP ให้กับ coding agent ใดก็ได้',
  'useEverywhere.section.mcp.intro': 'Open Docs มาพร้อมกับเซิร์ฟเวอร์ Model Context Protocol (`od mcp`) ที่ให้ client ใดก็ตามซึ่งรองรับ MCP — Cursor, Claude Code, Antigravity, VS Code Copilot Chat, openclaw, hermes — ค้นพบเครื่องมือของ Open Docs (แสดงรายการ skills, เรนเดอร์ตัวอย่าง, สร้างมีเดีย, รันปลั๊กอิน) ได้โดยไม่ต้องเรียกผ่าน shell เอง daemon จะเผยแพร่ snippet การติดตั้งที่พร้อมวางผ่าน `GET /api/mcp/install-info` สำหรับ client หลักแต่ละตัว',
  ...
  'useEverywhere.section.mcp.footer': 'ในแอป Open Docs ให้เปิด Settings → Integrations เพื่อคัดลอกคำสั่งติดตั้งเฉพาะ client (Cursor, Claude Code, Antigravity, VS Code) แทนการแก้ไข JSON ด้วยมือ',
  ...
  'useEverywhere.section.skills.snippet1': 'SKILL.md แบบขั้นต่ำ (front matter ที่เข้ากันได้กับ Claude + ส่วนเสริมของ Open Docs)',
  ...
  'entry.githubStarAria': 'ติดดาว Open Docs บน GitHub',
  ...
  'newproj.locationDefault': 'โปรเจกต์ Open Docs',
  ...
  'ds.searchPlaceholder': 'ค้นหา document styles…',
  'ds.emptyNoMatch': 'ไม่พบ document styles',
  ...
  'socialShare.openDesignSection': 'แชร์ Open Docs',
  'socialShare.openDesignTitle': 'Open Docs บน GitHub',
  'socialShare.openDesignText': 'Open Docs คือพื้นที่ทำงานแบบโอเพนซอร์สสำหรับการสร้าง แก้ไข เผยแพร่ และส่งต่อชิ้นงานออกแบบ',
  ...
  'socialShare.projectText': 'สร้างด้วย Open Docs: {title} ดูชิ้นงานที่เผยแพร่และกดดาวให้ repo: {repo}',
  'socialShare.projectCopyText': 'สร้างด้วย Open Docs: {title}\n{url}\nrepo ของ Open Docs: {repo}',
  ...
  'brandEnrichment.body': "Open Docs จะรันการดึงข้อมูลเชิงลึกในเบื้องหลัง ใช้ skills ของ document style ที่เหมาะสมโดยอัตโนมัติ และอัปเดตระบบนี้ในที่เดิม อาจใช้เวลา 10-20 นาที คุณยังทำงานต่อได้",
  ...
  'chat.activeFilePlaceholder': 'ขอให้ Open Docs แก้ไข {file}...',
  ...
  'chat.mode.design.solves': 'ใช้เมื่ออยากให้ Open Docs สร้างไฟล์ อัปเดต workspace หรือเปลี่ยน brief เป็นงานส่งมอบหลายรูปแบบ',
  ...
  'preview.shareTextDefault': 'เทมเพลต Open Docs: {title}',
  ...
  'designFiles.usefulInfoTip7': 'ถ้าชอบ Open Docs ฝากกดดาวให้เราบน GitHub',
  ...
  'assistant.shareToOpenDocs': 'แชร์ไปยัง Open Docs',
  'assistant.shareToOpenDocsBusy': 'กำลังเตรียมแพ็กเกจ…',
  ...
  'pet.tabBuiltInHint': 'จัดกลุ่มให้พร้อมใช้กับชุดระบบจาก Open Docs แล้ว — เอาได้เลย',
  ...
  'pet.codexBundledTitle': 'เตรียมมาให้กับ Open Docs แล้ว — ไม่ต้องดาวน์โหลดใหม่',
  ...
  'settings.designSystemsHint': 'จัดการว่า document style ใดบ้างที่จะปรากฏในแกลเลอรีหน้าแรก',
  ...
  'settings.projectLocationsDescription': 'เพิ่มฐานงานที่สามารถเก็บโฟลเดอร์โปรเจกต์ Open Docs ได้หลายรายการ โปรเจกต์ใหม่จะถูกบันทึกเป็นหนึ่งโฟลเดอร์ภายในฐานที่เลือก',
  ...
  'settings.libraryDesignSystems': 'ตัวของระบบแบบ Document Styles',
  ...
  'settings.customInstructionsHint': 'คำสั่งตายตัวที่ Open Docs ควรปฏิบัติตามในทุกการสนทนา บันทึกข้อเท็จจริง การตั้งค่า และบริบทของโปรเจกต์ไว้เป็นความทรงจำ',
  ...
  'settings.memoryStarterProjectDesc': 'Open Docs v0.5 — โปรแกรมแก้ไขดีไซน์ที่ขับเคลื่อนด้วยแชท',
  ...
  'updater.availableBody': 'Open Docs {version} พร้อมใช้งานแล้ว จะดาวน์โหลดก่อนเปิดตัวติดตั้ง',
  ...
  'updater.installerOpenBody': 'ตัวติดตั้งเปิดอยู่ Open Docs กำลังออกเพื่อให้คุณอัปเดตให้เสร็จ',
  ...
  'updater.quitButton': 'ออกจาก Open Docs',
  'updater.quitFailedBody': 'ตัวติดตั้งเปิดอยู่ แต่ไม่สามารถออกจาก Open Docs ได้ โปรดออกจาก Open Docs ก่อนแทนที่แอป',
  'updater.quitFailedTitle': 'ออกไม่ได้',
  'updater.quitting': 'กำลังออก...',
  'updater.ready': 'อัปเดตพร้อมแล้ว',
  'updater.readyGeneric': 'เวอร์ชันใหม่พร้อมแล้ว Open Docs จะปิดและเปิดตัวติดตั้ง',
  'updater.readyVersion': 'Open Docs {version} พร้อมแล้ว Open Docs จะปิดและเปิดตัวติดตั้ง',
  ...
  'automations.proposalsSub': 'ตรวจสอบผลลัพธ์ของระบบอัตโนมัติก่อนที่จะเปลี่ยนแปลงหน่วยความจำ ทักษะ หรือ document styles',
  ...
  'automations.tpl.designSystemRefresh.title': 'อัปเดต document styles จากอาร์ติแฟกต์ที่ส่งมอบแล้ว',
  ...
  'dsManager.areaAria': 'พื้นที่ document styles',
  'dsManager.tabDesignSystem': 'ระบบดีไซน์',
  'dsManager.tabTemplate': 'เทมเพลต',
  'dsManager.sourceAria': 'แหล่งที่มาของ document style',
  ...
  'dsManager.yourSystemsAria': 'document styles ของคุณ',
  'dsManager.eyebrowDesignSystems': 'ระบบดีไซน์',
  'dsManager.yourSystemsHeading': 'ระบบของคุณ',
  'dsManager.filterAria': 'กรอง document styles',
  'dsManager.filterAll': 'ทั้งหมด',
  'dsManager.filterPublished': 'เผยแพร่แล้ว',
  'dsManager.filterDraft': 'ฉบับร่าง',
  'dsManager.createTitle': 'สร้าง document style ใหม่',
  'dsManager.createBody': 'สอน Open Docs ให้รู้จักแบรนด์ ผลิตภัณฑ์ โค้ด แอสเซ็ต และข้อมูลอ้างอิงการออกแบบของคุณ',
  'dsManager.createAction': 'สร้าง',
  'dsManager.emptyMine': 'ยังไม่มี document styles สร้างจากบริบทผลิตภัณฑ์จริง ตรวจสอบฉบับร่าง แล้วเผยแพร่เพื่อใช้กับโปรเจกต์ในอนาคต',
  ...
  'dsManager.presetsAria': 'พรีเซ็ต document style อย่างเป็นทางการ',
  ...
  'dsManager.enterpriseDsBody': 'document styles ที่แชร์ในทีมและไลบรารีแบรนด์ที่มีการกำกับดูแลกำลังจะมาเร็วๆ นี้',
  ...
  'settings.customInstructionsDesc': 'คำสั่งตายตัวที่ Open Docs ปฏิบัติตามในทุกการแชต สิ่งเหล่านี้ไม่ใช่หน่วยความจำที่บันทึกไว้ ใช้ Memory สำหรับข้อเท็จจริง ความชอบ และบริบทของโปรเจกต์',
  ...
  'onboarding.buildBody': 'Open Docs เปลี่ยนแบรนด์ของคุณให้เป็นดีไซน์ซิสเต็มที่นำกลับมาใช้ซ้ำได้ แล้วทำให้ทุกสิ่งที่คุณสร้างสอดคล้องและตรงกับแบรนด์',
