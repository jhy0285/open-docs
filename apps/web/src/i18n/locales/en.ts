...
export const en: Dict = {
  ...
  'chat.amrCard.switchBody': 'Switch to Open Docs\'s official AMR model service — no API key setup needed. After you sign in, authorize, and top up, this run retries automatically.',
  ...
  'chat.runError.signInMessage.amr': 'The Open Docs agent isn\'t signed in yet — sign in to start using it.',
  'chat.runError.signInMessage.other': '{agent} isn\'t signed in. Check its sign-in status locally. We recommend the Open Docs agent — steadier and better value.',
  ...
  'settings.welcomeTitle': 'Welcome to Open Docs',
  'settings.welcomeSubtitle': '',
  'settings.onboardingCreateTitle': 'Start from a brief',
  'settings.onboardingCreateBody': 'Describe the site, app, deck, image, or video you want. Open Docs will create a project and keep the work editable.',
  ...
  'settings.onboardingMemoryCalloutBody': 'These answers seed your Memory profile. Open Docs reuses it on every task — and keeps learning as you work.',
  ...
  'settings.onboardingSystemsTitle': 'Bring your document style',
  ...
  'settings.onboardingStepDesignSystem': 'Build document style',
  'settings.onboardingStepProfile': 'Document profile',
  ...
  'settings.onboardingCloudTitle': 'Sign in to Open Docs',
  'settings.onboardingCloudBody': 'Sign in to start authoring documents with cloud AI right away — no complex setup required.',
  'settings.onboardingCloudSignIn': 'Sign in to Open Docs Cloud',
  ...
  'settings.onboardingGateTooltipAmr': 'The next steps run on AI — sign in to Open Docs AMR to continue.',
  ...
  'settings.onboardingDesignTitle': 'Document style',
  'settings.onboardingDesignBody': 'Define it once and reuse it across specs and deliverables.',
  ...
  'settings.onboardingProfileTitle': 'Document profile',
  'settings.onboardingProfileBody': 'Optional details for better specification and deliverable defaults.',
  'settings.onboardingRoleLabel': 'Role',
  'settings.onboardingOrgSizeLabel': 'Organization size',
  'settings.onboardingUseCaseLabel': 'Deliverable',
  ...
  'settings.onboardingRolePm': 'Planning / PM',
  'settings.onboardingRoleDesigner': 'Screen / UX planning',
  'settings.onboardingRoleEngineer': 'Engineering / architecture',
  'settings.onboardingRoleMarketing': 'Business / proposal',
  'settings.onboardingRoleAgency': 'SI / consulting',
  'settings.onboardingRoleGrowth': 'Operations improvement',
  'settings.onboardingRoleOps': 'Business operations',
  'settings.onboardingRoleFounder': 'Leader / decision maker',
  'settings.onboardingRoleStudent': 'Education / research',
  'settings.onboardingRoleOther': 'Other',
  'settings.onboardingUseProduct': 'Screen specification',
  'settings.onboardingUseDesignSystem': 'Document style standard',
  'settings.onboardingUsePrototype': 'New screen draft',
  'settings.onboardingUseLanding': 'URL / web screen documentation',
  'settings.onboardingUseAds': 'Notice / release material',
  'settings.onboardingUseDashboard': 'Dashboard / internal-tool spec',
  'settings.onboardingUseDeck': 'PPTX deliverable',
  'settings.onboardingUseMarketing': 'Proposal / report material',
  'settings.onboardingUseEngineering': 'Interface / API specification',
  'settings.onboardingUseAgency': 'Client deliverable',
  ...
  'settings.onboardingSourceCommunity': 'Docs / AI community',
  ...
  'settings.agentInstall.pathHint': 'If you installed a CLI with npm or Homebrew and it still shows as not installed, ensure the tool\'s bin directory is on the PATH the Open Docs daemon inherits (Terminal vs GUI apps can differ on macOS). See QUICKSTART.md (section "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Open Install or Docs for your preferred agent.',
  'settings.agentInstall.stepAuth': 'Authenticate with the vendor CLI (sign in or add API credentials) before returning to Open Docs.',
  ...
  'settings.appearanceHint': 'Choose light, dark, or cyberpunk.',
  ...
  'settings.mcpServerHint': 'Expose Open Docs as an MCP server for your coding agent.',
  ...
  'settings.privacyHint': 'Model input and optional product telemetry',
  'settings.privacyConsentKicker': 'How data is handled',
  'settings.privacyConsentLead': 'Open Docs does not keep conversation or tool content by default. When you run an agent, input sent to your selected CLI or BYOK model provider follows that provider policy. Product telemetry is optional:',
  'settings.privacyConsentFooter': 'You can turn optional telemetry on or off any time in Settings → Privacy.',
  'settings.privacyConsentShare': 'Share anonymous metrics',
  'settings.privacyConsentDecline': 'Don\'t share',
  'settings.privacyConsentAccept': 'I get it',
  'settings.privacyConsentBannerFooter': 'Product telemetry is off by default. Model input is sent only to the CLI or model provider you choose.',
  ...
  'settings.privacyContent': 'Conversation/tool content for quality review',
  'settings.privacyContentHint': 'Only when explicitly enabled, sends selected prompts, responses, and tool input/output for product quality review. Off by default.',
  'settings.privacyInstallationId': 'Anonymous ID',
  'settings.privacyOptedOut': 'opted out',
  'settings.privacyDataDeletion': 'Delete my data',
  'settings.privacyDataDeletionHint': 'Removes your anonymous ID and stops optional telemetry. Inputs already sent to a model provider follow that provider’s policy.',
  ...
  'settings.mcpHint': 'Let coding agents (Cursor, Claude Code, VS Code…) read your Open Docs projects directly.',
  'settings.mcpDaemonError': 'Couldn\'t reach the local daemon to resolve install paths ({error}). Make sure Open Docs is running, then reopen this panel.',
  ...
  'settings.mcpCapabilityDefault': 'Default to the project and file you have open in Open Docs, so you can say "build this in my app" without re-stating which design.',
  'settings.mcpRunningNote': 'Open Docs must be running for MCP tool calls to succeed. If you started your coding agent before opening Open Docs, restart the agent so it can reach the live daemon.',
  ...
  'entry.navBrands': 'Document Style',
  ...
  'homeHero.carousel.hint': 'Attach a file, link your document style, or describe what you want to make',
  ...
  'homeHero.footer.autoDesignSystemSummary': 'Automatically matches the best document style and visual style for the current prompt.',
  ...
  'homeHero.chip.createBrandKit': 'Create Document Style',
  ...
  'homeHero.chip.createBrandKitHint': 'Extract a document style from a website, then apply it in any chat.',
  'homeHero.chip.createPluginHint': 'Author a reusable Open Docs plugin and add it to My plugins.',
  'homeHero.chip.figmaHint': 'Migrate a Figma frame into the active document style.',
  ...
  'homeHero.chip.createBrandKitDesc': 'Extract a brand document style',
  ...
  'homeWorkingDir.hint': 'Let the agent read this local folder (not imported into Docs Files)',
  ...
  'handoff.promptIntro': 'Continue from this local Open Docs project folder:',
  ...
  'designSystemPicker.select': 'Choose document style',
  'designSystemPicker.loading': 'Loading document styles…',
  'designSystemPicker.searchPlaceholder': 'Search document styles (title / category / summary)',
  'designSystemPicker.searchCompactPlaceholder': 'Search document styles',
  'designSystemPicker.noneTitle': 'No document style',
  'designSystemPicker.noneSummary': 'No document style — the model freely improvises the visual style from your prompt.',
  'designSystemPicker.empty': 'No matching document styles',
  'designSystemPicker.openPreview': 'Open preview',
  'designSystemPicker.loadingPreview': 'Loading preview…',
  'designSystemPicker.noPreview': 'No preview page. Open Docs Systems to view the full preview.',
  'designSystemPicker.previewHint': 'Hover a document style to preview it',
  ...
  'pluginsHome.subtitle': 'Ready-to-use Open Docs workflows bundled with this runtime. Pick one to load a starter prompt, or browse the registry for more.',
  'pluginsHome.browseRegistry': 'Browse registry',
  'pluginsHome.count': '{filtered} of {total}',
  'pluginsHome.loadingCatalog': 'Loading catalog…',
  'pluginsHome.emptyCatalog': 'Catalog is empty. Bundled plugins ship with Open Docs and should appear here automatically — try restarting the daemon if this persists.',
  ...
  'pluginCard.contributeAria': 'Contribute {title} to Open Docs',
  'pluginCard.contributeTitle': 'Contribute plugin to Open Docs with a pull request',
  'skillPluginCandidate.createForMe': 'Create plugin/template',
  'skillPluginCandidate.contributeToMain': 'Contribute to Open Docs',
  'skillPluginCandidate.repoDescription': 'This repo looks like it could work as a plugin.',
  'integrations.kicker': 'Integration',
  'integrations.lede': 'Connect external systems, bring MCP tools into your agent loop, and use Open Docs from other IDEs, scripts, and automations.',
  ...
  'mcpClient.daemonError': 'Could not reach the local daemon. Make sure Open Docs is running, then reopen this panel.',
  'mcpClient.saveFailed': 'Save failed. Check that the daemon is running and try again.',
  'useEverywhere.modalAria': 'Use Open Docs everywhere',
  'useEverywhere.modalTitle': 'Use Open Docs everywhere',
  'useEverywhere.modalSubtitle': 'Drop Open Docs into any IDE, agent, or script — CLI, HTTP, MCP, and Skills. Use “Copy guide for an agent” and paste into Claude Code, Codex, Cursor, openclaw, or hermes to set up everything.',
  ...
  'useEverywhere.section.overview.heading': 'Open Docs works wherever your agent works',
  'useEverywhere.section.overview.intro': 'Open Docs is more than a window — it is a local privileged daemon (`od`) plus a Skills + Design-Systems + Atoms registry. Once it is running on your machine, any code agent (Claude Code, Codex, Cursor, OpenCode/openclaw, Hermes, your own script) can drive generations, inspect projects, and produce design artifacts through four interchangeable surfaces.',
  'useEverywhere.section.overview.bullet1': 'CLI — `od <command>` for headless scripts, CI, and shell automation.',
  'useEverywhere.section.overview.bullet2': 'MCP server — wires Open Docs as a Model Context Protocol server so any MCP-capable agent can list skills, run scenarios, and read artifacts.',
  ...
  'useEverywhere.section.overview.bullet4': 'Skills — drop-in `SKILL.md` packs (Claude-compatible) that any agent already on your PATH can invoke without Open Docs at all.',
  ...
  'useEverywhere.section.overview.footer': 'The daemon writes to `./.od/` (project-local) by default. Set `OD_DATA_DIR=~/.open-docs` to share data across projects.',
  'useEverywhere.section.cli.tab': 'CLI · od',
  'useEverywhere.section.cli.heading': 'Drive Open Docs from any shell',
  ...
  'useEverywhere.section.cli.snippet3': 'Inventory locally available skills and document styles',
  ...
  'useEverywhere.section.mcp.heading': 'Expose Open Docs as an MCP server to any coding agent',
  'useEverywhere.section.mcp.intro': 'Open Docs ships with a Model Context Protocol server (`od mcp`) that lets any MCP-capable client — Cursor, Claude Code, Antigravity, VS Code Copilot Chat, openclaw, hermes — discover Open Docs tools (list skills, render previews, generate media, run plugins) without shelling out manually. The daemon publishes a ready-to-paste install snippet via `GET /api/mcp/install-info` for each major client.',
  ...
  'useEverywhere.section.mcp.footer': 'In the Open Docs app, open Settings → Integrations to copy a client-specific install command (Cursor, Claude Code, Antigravity, VS Code) instead of editing JSON by hand.',
  ...
  'useEverywhere.section.skills.heading': 'Drop-in Skills for any agent — even without Open Docs running',
  'useEverywhere.section.skills.intro': 'A Skill is a directory with a Claude-compatible `SKILL.md` (YAML front-matter + body). Open Docs extends the format with the `od:` namespace (`mode`, `preview`, `design_system`, `inputs`, …) so the same artifact can be used both inside Open Docs and by a vanilla agent like Claude Code, Codex, openclaw, or hermes. Discovery follows a precedence chain so projects can override their own skills.',
  ...
  'useEverywhere.section.skills.snippet1': 'Minimal SKILL.md (Claude-compatible front matter + Open Docs extras)',
  ...
  'entry.githubStarAria': 'Star Open Docs on GitHub',
  ...
  'newproj.locationDefault': 'Open Docs projects',
  ...
  'newproj.importClaudeZip': 'Import Open Docs ZIP',
  'newproj.importClaudeZipTitle': 'Import an Open Docs .zip export',
  ...
  'newproj.dsSearch': 'Search document styles…',
  ...
  'newproj.dsEmpty': 'No document styles match “{query}”.',
  ...
  'ds.searchPlaceholder': 'Search document styles…',
  'ds.emptyNoMatch': 'No document styles match your search.',
  'ds.badgeDefault': 'DEFAULT',
  'ds.preview': 'Preview full system',
  'ds.previewTitle': 'Preview the full document style',
  'ds.categoryAll': 'All',
  ...
  'socialShare.openDesignSection': 'Share Open Docs',
  'socialShare.openDesignTitle': 'Open Docs on GitHub',
  'socialShare.openDesignText': 'Open Docs is an open-source workspace for creating, editing, deploying, and handing off design artifacts.',
  ...
  'socialShare.projectText': 'Built with Open Docs: {title}. View the deployed artifact and star the repo: {repo}',
  'socialShare.projectCopyText': 'Built with Open Docs: {title}\n{url}\nOpen Docs repo: {repo}',
  ...
  'project.brandReadyTitle': '{name} document style is ready',
  'project.brandReadyTitleGeneric': 'Your document style is ready',
  ...
  'brandEnrichment.body': "Open Docs will run a deeper extraction in the background, apply the right design-system skills automatically, and update this system in place. This can take 10-20 minutes; you can keep working.",
  ...
  'brandExtractionTranscript.user': 'Extract a document style from {source}.',
  'brandExtractionTranscript.doneTitle': 'Programmatic extraction finished for {name}.',
  'brandExtractionTranscript.doneBody': 'I created and registered the {designSystemId} document style from {source}. It is ready to preview and can be used in new designs now.',
  'brandExtractionTranscript.next': 'Next, choose a follow-up: refine the extracted document style with an agent pass that uses model tokens, or create a new design using this system.',
  ...
  'chat.activeFilePlaceholder': 'Ask Open Docs to change {file}...',
  'chat.designArtifactsShowMore': 'Show {count} more docs files',
  ...
  'chat.mode.design.summary': 'For creating or changing concrete document outputs: screen specs, interface specs, slide decks, Excel sheets, prototypes, and project files.',
  'chat.mode.design.solves': 'Use it when you want Open Docs to generate files, update the workspace, or turn a brief into document deliverables.',
  ...
  'chat.importSkills': 'Skills and document styles',
  'chat.importProject': 'Reference another project',
  'chat.importDesignSystemHeader': 'Choose a document style',
  'chat.importDesignSystemBack': 'Back',
  'chat.importDesignSystemSearch': 'Search document styles…',
  'chat.importDesignSystemEmpty': 'No document styles match "{query}"',
  ...
  'chat.importDesignSystemFailed': 'Couldn\'t switch document style. Please try again.',
  'chat.importDesignSystemLoadFailed': 'Couldn\'t load document styles.',
  ...
  'chat.designToolbox.searchPlaceholder': 'Search skills / MCP / plugins / connectors / docs files...',
  ...
  'chat.designToolbox.kind.designFile': 'Docs file',
  'chat.designToolbox.context.browser': 'Browser',
  'chat.designToolbox.context.designFiles': 'Docs files',
  ...
  'chat.designToolbox.prompt.contextGeneric': 'Current target: the currently open HTML / docs file / web element.',
  ...
  'chat.designToolbox.prompt.noSkill': 'If no specific skill matched, first choose the best combination from available skills, MCP, plugins, connectors, and docs files.',
  ...
  'chat.designToolbox.prompt.autoMatchStep2': '2. Search and match the full resource index above. Do not only use design toolbox recommendations; combine skills, MCP, plugins, connectors, and docs files when useful.',
  ...
  'chat.designToolbox.prompt.fileResource': 'Use this docs file as the current design target or reference asset and complete the next step from it. If other files need comparison, continue searching across all docs files.',
  'chat.designToolbox.prompt.resourceIndex': 'Global resource index: skills({skills}), plugins({plugins}), MCP({mcpEnabled} enabled / {mcpTemplates} templates), connectors({connectors} connected), docs files({files}).',
  ...
  'chat.designToolbox.prompt.referenceDesignFiles': 'Reference docs files',
  ...
  'chat.mentionTabFiles': 'Docs files',
  'chat.mentionNoResults': 'No results for “{query}”.',
  'chat.mentionSearchPrompt': 'Search Docs Files, tabs, plugins, skills, MCP servers, and connectors.',
  ...
  'chat.mentionSectionFiles': 'Docs files',
  ...
  'preview.shareTextDefault': 'Open Docs template: {title}',
  ...
  'preview.errorBody': 'The example HTML failed to fetch. Make sure Open Docs is running and try again.',
  'preview.retry': 'Retry',
  ...
  'workspace.designFiles': 'Docs Files',
  ...
  'workspace.designFilesLink': 'Docs Files',
  ...
  'designFiles.usefulInfoTip4': 'Pick a document style to keep generated designs on-brand.',
  ...
  'designFiles.usefulInfoTip7': 'Enjoying Open Docs? Star us on GitHub.',
  ...
  'assistant.shareToOpenDocs': 'Share to Open Docs',
  'assistant.shareToOpenDocsBusy': 'Preparing package…',
  ...
  'assistant.feedbackReasonPositiveDesignSystem': 'Followed the document style',
  ...
  'assistant.feedbackReasonNegativeDesignSystem': 'Did not follow the document style',
  ...
  'pet.tabBuiltInHint': 'Curated companions bundled with Open Docs — pick one and adopt.',
  ...
  'pet.codexBundledTitle': 'Ships with Open Docs — no download needed.',
  ...
  'settings.designSystems': 'Document Styles',
  'settings.designSystemsHint': 'Manage which document styles appear in the home gallery',
  'settings.designSystemsInstalled': 'Installed',
  'settings.designSystemsAdd': 'Add document style',
  ...
  'settings.designSystemsViewImported': 'View imported document style',
  ...
  'settings.projectLocationsDescription': 'Add work bases that can contain multiple Open Docs project folders. New projects are saved as one folder inside the selected base.',
  ...
  'settings.libraryDesignSystems': 'Document Styles',
  ...
  'settings.customInstructionsHint': 'Fixed instructions OpenDocs should follow in every chat. Save facts, preferences, and project context as memories.',
  ...
  'settings.memoryStarterProjectDesc': 'Open Docs v0.5 — chat-driven design editor',
  ...
  'updater.availableBody': 'Open Docs {version} is available. It will download before the installer can open.',
  ...
  'updater.installerOpenBody': 'The installer is open. Open Docs is quitting so you can finish the update.',
  ...
  'updater.quitButton': 'Quit Open Docs',
  'updater.quitFailedBody': 'The installer is open, but Open Docs could not quit. Quit Open Docs before replacing the app.',
  'updater.quitFailedTitle': 'Could not quit',
  'updater.quitting': 'Quitting...',
  'updater.ready': 'Update ready',
  'updater.readyGeneric': 'A new version is ready. Open Docs will close and open the installer.',
  'updater.readyVersion': 'Open Docs {version} is ready. Open Docs will close and open the installer.',
  ...
  'automations.proposalsSub': 'Review automation output before it changes memory, skills, or document styles.',
  ...
  'automations.tpl.designSystemRefresh.title': 'Update document styles from shipped artifacts.',
  ...
  'dsManager.yourSystemsAria': 'Your document styles',
  'dsManager.eyebrowDesignSystems': 'Document Styles',
  'dsManager.yourSystemsHeading': 'Your systems',
  'dsManager.filterAria': 'Filter document styles',
  'dsManager.filterAll': 'All',
  'dsManager.filterPublished': 'Published',
  'dsManager.filterDraft': 'Draft',
  'dsManager.createTitle': 'Create new document style',
  'dsManager.createBody': 'Teach Open Docs your brand, product, code, assets, and design references.',
  'dsManager.createAction': 'Create',
  'dsManager.emptyMine': 'No document styles yet. Create one from real product context, review the draft, then publish it for future projects.',
  ...
  'dsManager.downloadTitle': 'Download document style (.zip + SKILLS.md)',
  'dsManager.downloadAria': 'Download {title} as a .zip',
  'dsManager.downloadFailed': 'Could not download the document style. Please try again.',
  'dsManager.deleteConfirm': 'Delete "{title}"? This removes the draft document style from this device.',
  ...
  'dsManager.presetsAria': 'Official document style presets',
  ...
  'dsManager.enterpriseDsTitle': 'Enterprise document styles',
  'dsManager.enterpriseDsBody': 'Shared team document styles and governed brand libraries are coming soon.',
  ...
  'settings.customInstructionsDesc': 'Fixed instructions Open Docs follows in every chat. These are not saved memories; use Memory for facts, preferences, and project context.',
  ...
  'brand.libraryTitle': 'Document Style',
  'brand.librarySubtitle': 'Teach Open Docs your document styles — extract one from a website, then apply it in any chat.',
  'brand.newBrand': 'New Document Style',
  'brand.searchPlaceholder': 'Search your document styles…',
  'brand.empty': 'No document styles yet. Extract one from a website to get started.',
  ...
  'brand.previewEmpty': 'Select a document style to preview',
  'brand.viewDetails': 'View details',
  'newBrand.title': 'New Document Style',
  ...
  'brandDetail.delete': 'Delete document style',
  'brandDetail.back': 'Document Style',
  'brandDetail.refining': 'Refining this document style…',
  ...
  'brandDetail.deleteConfirm': 'Delete "{name}"? This removes the document style.',
  ...
  'onboarding.brandTitle': 'Extract your document style',
  'onboarding.brandSubtitle': 'Paste a website and we\'ll turn its brand signals into a reusable document style for future work.',
  'onboarding.brandSkip': 'Skip',
  'onboarding.brandDone': 'Design system extracted',
  'onboarding.buildTitle': 'Create once, build everywhere',
  'onboarding.buildBody': 'Open Docs turns your brand into a reusable document style — then keeps everything you build on-brand and consistent.',
  ...
  'onboarding.buildStart': 'Build a document style',
  ...
  'brandPicker.subtext': 'Click any brand to extract its document style straight from its website.',
  ...
  'ds.deleteProjectConfirm': 'Delete "{title}"? This permanently removes this document style and its project from this device.',
