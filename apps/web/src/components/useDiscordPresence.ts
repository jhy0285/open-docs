...
import type { OpenDocsDiscordPresenceResponse } from '@open-design/contracts';
...
function cacheFromPayload(payload: Partial<OpenDocsDiscordPresenceResponse>): CachedPresence | null {
  if (
