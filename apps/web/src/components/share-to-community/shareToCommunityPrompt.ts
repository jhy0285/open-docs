// Trigger prompt for the post-completion "Share to Open Docs" submission
...
export const SHARE_TO_COMMUNITY_PROMPT = [
  'Package the work I just finished in this project as an Open Docs plugin so I can install it into My plugins and open a PR to the Open Docs community catalog.',
  '',
  ...
  '- **Open Docs PR** — opens a draft PR against `jhy0285/open-docs` for the community catalog.',
  '',
