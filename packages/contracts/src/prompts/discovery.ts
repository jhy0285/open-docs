...
{
  "description": "I'll route this through the right Open Docs workflow and lock the brief in one shot. Skip what doesn't apply — I'll fill defaults.",
  "questions": [
    {
      "id": "taskType",
